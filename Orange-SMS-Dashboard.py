...
# add library path
path = 'C:\\Users\\WKOUBAA\\Documents\\Python Scripts\\python_orange_sms-master'
path_DataBase=path+'\\DataBase'
path_History=path+'\\History_Compaign'
os.environ['PATH'] += ':'+path
os.environ['PATH'] += ':'+path_DataBase
os.environ['PATH'] += ':'+path_History
#API key for orange sms app


SENDER_NAME = 'SMS marketing'
AUTH_TOKEN = 'Basic WjhrTjhYUlFrc2dQV1U3ZXFXY3g5SHVvYWppVmJYdDQ6Y3Q3dllVaEdsNTBHblpFQQ=='
